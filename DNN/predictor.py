# -*- coding: utf-8 -*-
"""
Created on Sat Nov 10 11:12:10 2018
...
def read_img_files_aug(file, label):
    file_str = tf.compat.as_str(file)
...
def get_args():
    ...
    parser.add_argument("-ip","--input_folder", required=True,
                        help="Folder of images. (PGM files)")

    parser.add_argument("-o","--output_file", required=True,
                        help="Folder to output checkpoints.")
    
    
    parser.add_argument("-m","--pretrained_model", required=True,
                        help="folder path of pretrained checkpoint.")
...
if __name__ == "__main__":
    ...
    with graph_resClass.as_default():                    
        ...
        for file in X_test:
            ...
            outp = sess_resClass.run(softmax_out, feed_dict={X: img.reshape(1, INPUT_HEIGHT, INPUT_WIDTH, 1), keep_prob: 1.0})
